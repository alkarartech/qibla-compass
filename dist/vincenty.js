 ...
 */
export function bearingGreatCircle(lat1Deg, lon1Deg, lat2Deg, lon2Deg) {
 ...
 */
export function bearingVincenty(lat1Deg, lon1Deg, lat2Deg, lon2Deg) {
    const φ1 = toRad(lat1Deg);
    const φ2 = toRad(lat2Deg);
    ...
    for (let i = 0; i < MAX_ITERATIONS; i++) {
        ...
        const sinσ = Math.sqrt((cosU2 * sinλ) ** 2 +
            (cosU1 * sinU2 - sinU1 * cosU2 * cosλ) ** 2) || 0;
 ...
 */
export function getBearing(fromLat, fromLon, toLat, toLon) {
